...
describe('Separator', () => {
  it('renders the default wave separator', () => {
    ...
    expect(separator).toHaveClass('separator', 'separator--wave', 'w-full')
  ...
  it('allows custom class names', () => {
    ...
    expect(container.querySelector('.separator')).toHaveClass('mt-0')
  })

  it('sets a custom bottom background CSS variable', () => {
    const { container } = render(<Separator bottomBackground="var(--main-pitch-bg)" />)
    const separator = container.querySelector('.separator') as HTMLDivElement
